    ...
    return (
        <div className={classes['list']}>
            <div className={classes['list__wrapper']}>
                ...
                <span className={classes['list__date']}>07.03.2022</span>
                <p className={classes['list__description']}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
            </div>
            <div className={classes['list__buttons']}>
                <div className={classes['list__buttons-edit']}>
                ...
                <div className={classes['list__buttons-trash']}>
                    ...
                    <span className={classes['list__buttons-trashText']}>Удалить</span>
                </div>
            </div>
        </div>
    )
